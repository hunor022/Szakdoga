...
\def\keywords{mechatronika, szabályozástechnika, szenzortechnika, mezőgazdaság, mezőgazdasági automatizáció, agritech, silózó, felszedő adapter, forage harvester, collection header, fordulatszámmérés, visszajelzőrendszer, programozható relé, Smart Relay, Programmable Relay}
...
\include{chapters/szakirodalmi_attekintes}      % 2. fejezet
\include{chapters/merorendszer_fejlesztese}    	% 3. fejezet
